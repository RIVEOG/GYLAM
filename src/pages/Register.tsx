        ...
        <form onSubmit={handleSubmit} className="card space-y-4 p-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input className="input pl-9" required value={username} onChange={(e) => setUsername(e.target.value)} placeholder="yourname" />
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="relative">
              <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-600" />
              <input className="input pl-9" type="password" required value={confirm} onChange={(e) => setConfirm(e.target.value)} placeholder="••••••••" />
            </div>
          </div>
