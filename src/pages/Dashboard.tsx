  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">Here's your Gylam Panel overview.</p>
      </div>
          ...
          <div key={s.label} className="card p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-2xl font-bold text-slate-100">{s.value}</p>
              </div>
      ...
      <div className="card p-6">
        ...
        <div className="mt-4 flex flex-col items-center justify-center py-12 text-center">
          <Server size={32} className="mb-3 text-slate-700" />
          <p className="text-sm text-slate-400">No servers yet</p>
          <p className="text-xs text-slate-600">Create your first game server to get started.</p>
        </div>
      </div>
    </div>
  );
